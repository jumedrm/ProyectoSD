...
/*mazo/baraja completa, lista de listas. 
  Lista externa de 57 cartas y cada lista interna tiene 8 números de esa carta.*/	
 ...
 /*
  ...
  - Se van a generar 57 cartas, cada una con 8 números distintos (entre el 1 y el 57) y se va a cumplir que
    dos cartas cualesquiera, sólo tienen un número en común.
  */
 public List<List<Integer>> generarMazoDobble() {
     ...
     //El método divide las 57 cartas en tres grupos principales (49 líneas finitas, 7 líneas verticales y 1 línea especial)
     ...
     for (int m = 0; m < ORDEN; m++) {//m va de [0,...,6], m la pendiente
         ...
         for (int k = 0; k < ORDEN; k++) { // k va de [0..6], k el desplazamiento
             ...
             //va a ver 7 primeras cartas con el símbolo 50 en común, las 7 siguientes con el 51 
     ...
     //Esta única carta recoge los 7 símbolos de pendiente (50 a 56) y el Símbolo Infinito (57). 
     //Esta es la carta que garantiza la coincidencia con las 7 cartas de pendiente infinita.
 ...
 /*
   ...
   - El remove(0), elimina del mazo la primera carta y la devuelve con el return, 
     en este caso como la carta es una lista de 8 enteros, devuelve la lista de números de esta primera carta
  */
 ...
 /*
   ...
   Esta es la lógica de validación.
  */
